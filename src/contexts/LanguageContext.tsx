...
const getTranslations = (lang: Language): Record<string, string> => {
  const translations = {
    fr: {
      ...
      'transaction.title': 'DÉTAILS DE LA TRANSACTION',
      'transaction.date': 'Date d\'initiation:',
    ...
    en: {
      ...
      'transaction.date': 'Initiation date:',
    ...
    de: {
      ...
      'reference': 'Referenz',
      'transaction.title': 'TRANSAKTIONSDETAILS',
      'transaction.date': 'Initiierungsdatum:',
    ...
    da: {
      ...
      'reference': 'Reference',
      'transaction.title': 'TRANSAKTIONSDETALJER',
      'transaction.date': 'Initieringsdato:',
